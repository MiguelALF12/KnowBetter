...
"}")
        ...
        # ----------Back page button----------
        self.back_page_pushButton = QtWidgets.QPushButton(self.body_horizontalFrame)
...
"")
        ...
        # ----------Front page button----------
        self.front_page_pushButton = QtWidgets.QPushButton(self.body_horizontalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "KNOW BETTER - ANALIZA TUS EJERCICIOS"))
...
"GENERAL"))
    ...
    def getAndSendExcercise(self):
        ...
        if len(text) <= 0:
            self.show_pop_up("No ha ingresado el ejercicio para analizar", QMessageBox.Warning)
        else:
